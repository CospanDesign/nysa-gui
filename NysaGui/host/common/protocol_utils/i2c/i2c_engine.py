...
class I2CEngine (QtCore.QObject):
    ...
    def __init__(self, i2c_driver, status, actions, server):
        ...
        self.status.Verbose( "Starting I2C Engine")
    ...
    def process_transaction(self, transaction):
        ...
        #self.status.Debug( "Transaction complete")
        return read_data

    def reset_i2c(self):
        self.status.Debug( "Reset I2C Core")
        self.i2c.reset_i2c_core()

    def set_speed_to_100khz(self):
        self.status.Debug( "Set I2C Rate to 100Khz")
        self.i2c.set_speed_to_100khz()

    def set_speed_to_400khz(self):
        self.status.Debug( "Set I2C Rate to 400Khz")
        self.i2c.set_speed_to_400khz()

    def set_custom_speed(self, rate):
        self.status.Debug( "Set I2C Rate to a custom rate: %dkHz" % rate)
