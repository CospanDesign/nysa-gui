...
class _Actions(QtCore.QObject):
    ...
    ibuilder_module_selected = QtCore.pyqtSignal(str, name = "ibuilder_module_selected")
    ibuilder_module_deselected = QtCore.pyqtSignal(str, name = "ibuilder_module_deselected")
